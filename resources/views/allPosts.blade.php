@extends('.dashboard')
@section('allPosts')
    <h2 class="all-posts-heading">All blog posts</h2>

    <div class="row posts-parent">
        @foreach($allPosts  as $post)
            <div class="col-md-2 post mx-4">
                <a href="/post-details/{{ $post->id }}"> <a href="/post-details/{{ $post->id }}">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12 like-btn-parent">
                            @auth
                                <div class="row">
                                    <div class="col-md-12 mt-3 like-name-parent text-success">
                                        ...
                                        <div class="col-md-6">
                                            <form action="/likePost/{{ $post->id }}" method="GET">
                                                    @if(count($liked_ids) && in_array($post->id, $liked_ids))
